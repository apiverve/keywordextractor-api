# Keyword Extractor API - Examples

This folder contains example code for using the Keyword Extractor API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/keywordextractor',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/keywordextractor");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/keywordextractor](https://docs.apiverve.com/ref/keywordextractor)
